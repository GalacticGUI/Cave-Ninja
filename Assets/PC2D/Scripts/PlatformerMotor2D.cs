...
public class PlatformerMotor2D : MonoBehaviour
{
    ...
    private bool UpdateMovingPlatform()
    {
        ...
        Collider2D col = Physics2D.OverlapArea(
            checkBounds.min, 
            checkBounds.max,
            movingPlatformLayerMask);    // changing from _collisionMask as per PenguinX45654
                                        // fixes getting stuck in slopes after implementing moving platforms into a project
